...
// File: app/api/sentence-bundle/route.js (App Router)
...
- Keep sentences natural and compact; vary structure (questions, negation, tense, time/place).`;
  ...
  return NextResponse.json({ ok: true, items, sentences: items, list: items, lexicon_used: (lexicon && lexicon.length) ? lexicon.length : 0 }, {
    status: 200,
